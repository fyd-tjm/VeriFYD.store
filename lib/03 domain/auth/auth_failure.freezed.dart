...
/// @nodoc
abstract class _$$InvalidOtpEnteredCopyWith<$Res> {
  factory _$$InvalidOtpEnteredCopyWith(
          _$InvalidOtpEntered value, $Res Function(_$InvalidOtpEntered) then) =
      __$$InvalidOtpEnteredCopyWithImpl<$Res>;
}
...
class _$InvalidOtpEntered implements InvalidOtpEntered {
  const _$InvalidOtpEntered();

  @override
  String toString() {
    return 'AuthFailure.invalidOtpEntered()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$InvalidOtpEntered);
  }
...
abstract class InvalidOtpEntered implements AuthFailure {
  const factory InvalidOtpEntered() = _$InvalidOtpEntered;
}
