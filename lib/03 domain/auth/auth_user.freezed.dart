...
class _$_AuthUser implements _AuthUser {
  const _$_AuthUser({required this.userId, required this.userPhone});
  ...
  @override
  String toString() {
    return 'AuthUser(userId: $userId, userPhone: $userPhone)';
  }
...
abstract class _AuthUser implements AuthUser {
  const factory _AuthUser(
      ...
      required final String userPhone}) = _$_AuthUser;
